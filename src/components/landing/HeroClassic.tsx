...
import { Zap, Star, ShoppingBag, Sparkles } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { logAbEvent } from '@/lib/ab-test'

// VARIANTE B del test A/B: hero clásico centrado (gradiente violeta, texto grande).
// Copy neutralizado a LatAm para comparar DISEÑO, no mensajes de país.
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-violet-100 max-w-2xl mx-auto mb-6 leading-relaxed">
            ...
            cobra con los <strong className="text-white">métodos de pago de tu país</strong>,
