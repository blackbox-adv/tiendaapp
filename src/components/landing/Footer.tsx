        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a href="https://instagram.com/tiendapp" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-9 h-9 rounded-lg bg-gray-100 hover:bg-[#F6E7DE] flex items-center justify-center text-gray-500 hover:text-[#BC5A38] transition-colors">
              ...
              <a href="https://facebook.com/tiendapp" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 rounded-lg bg-gray-100 hover:bg-[#F6E7DE] flex items-center justify-center text-gray-500 hover:text-[#BC5A38] transition-colors">
