...
export default function StoreTemplateRenderer({ slug }: StoreTemplateRendererProps) {
      ...
      <div className={`relative ${bannerGradient} text-white`}>
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-16 sm:py-24">
          ...
          <div className="flex items-center gap-4 mb-4">
            {store.logo ? (
              <div className="w-16 h-16 bg-white/20 backdrop-blur rounded-2xl overflow-hidden">
          ...
          {filteredProducts.map((product, index) => (
            ...
            >
              <div className="aspect-square relative overflow-hidden bg-gray-100">
                <img
                  src={product.image || placeholderImages[index % placeholderImages.length]}
                  alt={product.name}
